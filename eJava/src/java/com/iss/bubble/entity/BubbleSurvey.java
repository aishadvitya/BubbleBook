...
public class BubbleSurvey extends Bubble implements Serializable {
...
//    private Integer bubbleId;
    ...
    public double getAnswer5Count() {
        return answer5Count;
    }

    public void setAnswer5Count(double answer5Count) {
